<?php 
  ...
  $include_data   = $site_root . "/data/data_massage.php";
...
?>
	...
	<div class="col-md-8">
		...
		<?php
			...
			echo "<h2>Swedish Massage</h2>";	
			treatment_table_duration($treatment_list_1);

			echo "<h2>Indian Head Massage</h2>";	
			treatment_table_duration($treatment_list_2);			

			echo "<h2>Lava Shell Massage</h2>";	
			treatment_table_duration($treatment_list_3);
		?>
