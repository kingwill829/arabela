<?php 
  ...
  $include_data   = $site_root . "/data/data_for_men.php";
...
?>
	...
	<div class="col-md-8">
		<?php
			...
			echo "<h2>Waxing</h2>";
			if (isset($treatment_list_1)) {
				treatment_table($treatment_list_1);
			}
			echo "<h2>Facials</h2>";
			if (isset($treatment_list_2)) {
				treatment_table($treatment_list_2);
			}		
			echo "<p>Both of the above treatments are suitable for deep cleansing to the back</p>";	
			echo "<h2>Nails</h2>";
			if (isset($treatment_list_3)) {
